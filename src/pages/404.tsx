  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(0deg, #1A1A1A 3.79%, rgba(16, 16, 16, 0) 100%), url(https://www.themoviedb.org/t/p/original/achmETPRJZc9QVXsMPgHwYEyNar.jpg) no-repeat center`,
